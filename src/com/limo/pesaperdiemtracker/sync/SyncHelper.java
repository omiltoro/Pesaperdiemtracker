...
import com.limo.confconnect.gson.MyGson;
import com.limo.confconnect.http.HTTP;
import com.limo.pesaperdiemtracker.helpers.CameraFileSave;
...
import com.limo.pesaperdiemtracker.models.Sync;
...
import com.limo.pesaperdiemtracker.models.Data;
...
public class SyncHelper extends AsyncTask<Void, Void, Void>{
	...
	private void pullFiles() {
		...
		List<Favorite> favourites = convertCursorToListString.getFavoriteListFilesToDownload();
