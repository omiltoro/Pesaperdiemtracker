...
import com.limo.pesaperdiemtracker.helpers.CustomDatePickerDialog;
...
public class GenerateReport extends BaseActivity implements OnClickListener {
	...
	private abstract class Export extends AsyncTask<Void, Void, Void> {
		...
		protected void setFile() {
			File dir = new File(Environment.getExternalStorageDirectory()+"/PesaPerdiem");
	...
	private class ExportPDF extends Export {
		...
		// add metadata to the PDF which can be viewed in your Adobe Reader
	 	...
	 	private void addMetaData(Document document) {
	 		document.addTitle("Expenses Report using Expense Tracker (limo)");
	 		document.addSubject("PDF created using android app \"Expense Tracker (limo)\"");
	 		document.addKeywords("Android, PDF, limo, Expense, Tracker, Expense Tracker");
	 		document.addAuthor("limo");
	 		document.addCreator("limo");
	 	}
		...
		private void addEmptyLine(Paragraph paragraph, int number) {
	 	...
	 	public class HeaderAndFooter extends PdfPageEventHelper {
	 		...
	 		public HeaderAndFooter() {
	 			...
	 			Chunk chunk = new Chunk("Report Generated Using - Expense Tracker (limo)");
